...
urlpatterns = [
    ...
    path('onetomany/',views.one_to_many_demo, name='one_to_many'),
    path('manytomany/',views.many_to_many_demo, name='many_to_many'),
    ...
    path("delete_post/<int:post_id>",views.delete_blog_post, name="delete_blog"),
